...
![](/assets/using_images/webui_home.png){ width="100%" }

/// caption
Placeholder: main WebUI layout
///
...
![](/assets/using_images/webui_status_messages.png){ width="100%" }

/// caption
Placeholder: WebUI status and message area
///
...
![](/assets/using_images/webui_navigation.png){ width="100%" }

/// caption
Placeholder: WebUI navigation and main sections
///

Used this way, the WebUI stops feeling like a collection of unrelated screens and starts to feel like what it really is: the front panel of your Allsky system.
