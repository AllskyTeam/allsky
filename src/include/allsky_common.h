...
#define DEFAULT_NIGHTMEAN_THRESHOLD_RPi	0.1	
...
#define DEFAULT_DAYMEAN_ZWO				0.5
#define DEFAULT_NIGHTMEAN_ZWO			0.2		// TODO: pure guess as of May 22, 2023
#define DEFAULT_DAYMEAN_THRESHOLD_ZWO	0.1
#define DEFAULT_NIGHTMEAN_THRESHOLD_ZWO	0.1
