...
function ListMeteors($aDay = null)
{
	...
	foreach ($meteorFiles as $meteor) {
		...
		$thumbnailUrl = '/images/' . rawurlencode($day) . '/meteorsthumbnails/' . rawurlencode($name);
		...
		$markedThumbnailUrl = '/images/' . rawurlencode($day) . '/meteorsthumbnails/' . rawurlencode($markedName);
