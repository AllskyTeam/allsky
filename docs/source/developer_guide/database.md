...
## Database Structure { data-toc-label="Database Structure" }
...
## The Meta Data Database Section { data-toc-label="The Meta Data Database" }
...
## Some examples { data-toc-label="Some examples" }

**NOTE:** In all of these examples only the `extradata` prtion of the `meta_data` is shown

### Example 1 - Full save { data-toc-label="Example 1 - Full save" }
...
### Example 2 - Limiting Pipelines { data-toc-label="Example 2 - Limiting" }
...
### Example 3 - Setting the primary key { data-toc-label="Example 3 - Setting" }
...
## Writing across tables { data-toc-label="Writing across tables" }
...
## Database Purging { data-toc-label="Database Purging" }
...
#### Defined purging { data-toc-label="Defined purging" }
