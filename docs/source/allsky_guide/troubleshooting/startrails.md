...
![](/assets/troubleshooting_images/startrails.png)

/// caption
An Example Startrail Image
///

## Creating a startrails image { data-toc-label="Creating startrails" }
