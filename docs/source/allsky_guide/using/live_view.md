...
![](/assets/using_images/live_view_page.png){ width="100%" }

/// caption
Placeholder: main Live View page
///
...
![](/assets/using_images/live_view_fullscreen.png){ width="100%" }

/// caption
Placeholder: Live View in fullscreen mode
///
...
![](/assets/using_images/live_view_mini_timelapse_link.png){ width="100%" }

/// caption
Placeholder: mini-timelapse link in the Live View header
///
