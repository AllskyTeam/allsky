                ...
                <div class="panel-body markdown-body">
                    <div class="alert alert-success" role="alert">
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#as-support-pref" role="tab" data-toggle="tab">Automated Method</a></li>
                            <li role="presentation"><a href="#as-support-alt" role="tab" data-toggle="tab">Manual Method</a></li>
                        </ul>
